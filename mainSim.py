...
if __name__ == '__main__':
 ...
 #   totalFinalBatteryCap = 10000000.0 # 10 GW in 2050
            ...
            for eGC in elecGenCompanies:
                if(eGC.name == curCompName):
                    ...
                    if tempName == 'Wind Offshore':
                        ...
                        renGen = renewableGenerator('Wind Offshore', genTypeID,8760, tempCapKW, lifetime, 0.0,1,OneYearHeadroom[0]) # temporary generator to estimate the annual costs
    ...
    # distGenCompany = generationCompany(timeSteps, path_technology_dataset, BASEYEAR)
    ...
    #                 print('2 ')
    #                 input('wait')
    #             distGenCompany.addGeneration('Wind Offshore', -1, 1, cap, lifetime, sYear, 2052, 0, yearCost, True, False, tempbus, OneYearHeadroom[tempbus-1])
    ...
    #             lifetime = eYear - sYear
    #             distGenCompany.addGeneration('Wind Onshore', -1, 1, cap, lifetime,sYear, eYear, 0, 0.0, False, False, tempbus, OneYearHeadroom[tempbus-1])
    ...
    # lifetime = int(technologies_dataset.loc['Solar', 'Lifetime_Years'])
    # distGenCompany.addGeneration('Solar', -1, 1, sCapkW, lifetime,avgPVStartYear, 2052, (avgPVStartYear-BASEYEAR), 0.0, False, False, temprand, OneYearHeadroom[temprand-1])

    # temprand=random.randint(1,30)
    # lifetime = int(technologies_dataset.loc['Wind Onshore', 'Lifetime_Years'])
    # distGenCompany.addGeneration('Wind Onshore', -1, 1, wOnCapkW, lifetime, avgWindOnStartYear, 2052, (avgWindOnStartYear-BASEYEAR), 0.0, False,  False, temprand, OneYearHeadroom[temprand-1])
    ...
    # lifetime = int(technologies_dataset.loc['Wind Offshore', 'Lifetime_Years'])
    # distGenCompany.addGeneration('Wind Offshore', -1, 1, wOffCapkW, lifetime, avgWindOffStartYear, 2052, (avgWindOffStartYear-BASEYEAR), yearCost, True, False,temprand, OneYearHeadroom[temprand-1])
    ...
    #     lifetime = int(technologies_dataset.loc['BECCS', 'Lifetime_Years'])
    ...
    #                 #addGeneration(self, genName, genTypeID, renewableID, capacityKW, lifetime, startYear, endYear, age, subsidy, cfdBool, capMarketBool, BusNum, Headroom)
    ...
    #     lifetime = int(technologies_dataset.loc['Hydrogen', 'Lifetime_Years'])
